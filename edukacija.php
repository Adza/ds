...
<div class="cv-inputs">
  ...
  ?>
      ...
      <br />
        <br />
      <h1>Grad:</h1>
      <input type="text" class="form-input grad-naziv predict-grad-big"/>
      <div class="predict-list predict-grad-list"></div>
      <input type="hidden" class="form-input hidden-grad edu-sr-grad"/>
        <br />
          <br />
      <h1>Smjer:</h1>
    ...
    <div class="lista-dodatnih-jezika">
        ...
        ?>
            <div class="dodatni-jezik" style="padding-bottom:20px;margin-bottom:20px;border-bottom:1px solid #d5d5d5;">
              ...
              ?>
              <input type="hidden" class="edu-jezici-edit" value="<?=$item['id'];?>" />
                <br />
